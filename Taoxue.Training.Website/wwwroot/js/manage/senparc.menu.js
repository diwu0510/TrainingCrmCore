...
senparc.menu = {
    ...
    init: function () {
        ...
        $('#menuLogin_Submit').click(function () {
            $.getJSON('/Manage/WxMenu/GetToken?t=' + Math.random(), { appId: $('#menuLogin_AppId').val(), appSecret: $('#menuLogin_AppSecret').val() },
                function (json) {
        ...
        $('#btnGetMenu').click(function () {
            ...
            $.getJSON('/Manage/WxMenu/GetMenu?t=' + Math.random(), { token: senparc.menu.token }, function (json) {
                if (json.menu) {
        ...
        $('#btnDeleteMenu').click(function () {
            ...
            $.getJSON('/Manage/WxMenu/DeleteMenu?t=' + Math.random(), { token: senparc.menu.token }, function (json) {
                if (json.success) {
        ...
        $('#submitJsonMenu').click(function () {
            ...
            $.post('/Manage/WxMenu/CreateMenuFromJson', { token: $('#tokenStr').val(), fullJson: jsonStr }, function (json) {
                if (json.success) {
                    menuState.html('上传成功');
                } else {
                    menuState.html(json.message);
        ...
        $('#btnGetAccessToken').click(function () {
            //$('#menuEditor').hide();
            //$('#menuLogin').show();
            $.get("/Manage/WxMenu/GetToken", {}, function (data) {
                if (data.error) {
                    alert(data.error);
                } else {
                    senparc.menu.token = data;
                    $("#tokenStr").val(data);
                }
            });
        });
